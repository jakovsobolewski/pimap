...
const SHELL_CACHE = 'lkp-shell-v39';
const TILE_CACHE = 'lkp-tiles-v1';
const ROUTE_CACHE = 'lkp-routes-v1';
const SHELL = [
  './', './index.html', './styles.css', './app.js', './data.js', './mds.js', './pois.js', './i18n.js', './profile.js', './about.html', './tallinn-logo.svg', './pinge-logo.jpg', './concrete-bg.jpg', './concrete-bg-phone.jpg', './manifest.json', './icon.svg',
