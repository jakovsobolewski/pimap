  ...
  function renderWelcome() {
    ...
    el.innerHTML = `<div class="ob-wrap">
      <div class="ob-card" role="dialog" aria-modal="true" aria-labelledby="obTitle">
        <div class="ob-top">
          <div class="ob-brand"><span class="ob-logo" data-no-i18n>Pi<b>Map</b></span><span class="ob-tag">Your nearest shelter and the safest way there, every day and in an emergency.</span></div>
